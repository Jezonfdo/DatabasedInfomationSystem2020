...
{
    public partial class RemoveTeachers : Form
    {
        ...
        private void RemoveTeachers_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string delete_query = "DELETE FROM Teachers WHERE ID=" + int.Parse(textBoxID.Text);
