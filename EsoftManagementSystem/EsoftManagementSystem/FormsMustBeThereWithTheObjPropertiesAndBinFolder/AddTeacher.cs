    ...
    public partial class AddTeacher : Form
    {
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var InsertQuery = "INSERT INTO Teachers(ID,Name,DateOfBirth,Telephone,Course,Gender,Salary,Age,DateJoined) VALUES('" + textBox8.Text + "','" + textBox1.Text + "','" + textBox2.Text + "','" + textBox4.Text + "','" + textBox5.Text + "','" + comboBox1.Text + "','" + textBox6.Text + "','" + textBox3.Text + "','" + textBox7.Text + "')";
